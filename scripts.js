...
let firstIndex3D = 124;                // current max = 14 x 12 = 168 - 4 = 164
let firstIndexFractals = 135;          // current max = 38 x 12 = 456 - 4 = 452
let firstIndexAutomata = 124;          // current max = 35 x 12 = 420 - 4 = 404
let firstIndexAttractors = 124;        // current max = 30 x 12 = 360 - 4 = 356
