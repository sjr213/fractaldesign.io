...
let firstIndex3D = 148;                // current max = 15 x 12 = 180 - 4 = 176
let firstIndexFractals = 160;          // current max = 38 x 12 = 456 - 4 = 452
let firstIndexAutomata = 148;          // current max = 35 x 12 = 420 - 4 = 404
let firstIndexAttractors = 148;        // current max = 30 x 12 = 360 - 4 = 356
